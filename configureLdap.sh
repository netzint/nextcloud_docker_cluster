...
docker exec --user www-data -it nextcloud_docker_cluster_fpm01_1 /var/www/html/occ ldap:set-config s01 ldapGroupFilter                '(&(|(objectclass=group))(|(sophomorixType=teacherclass)(sophomorixType=project)(sophomorixType=adminclass)(sophomorixType=ouclass)(sophomorixType=school)))'
...
docker exec --user www-data -it nextcloud_docker_cluster_fpm01_1 /var/www/html/occ ldap:set-config s01 ldapNestedGroups               1
